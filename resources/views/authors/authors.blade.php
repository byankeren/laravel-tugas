  ...
  <div class="grid gap-10 my-10">
    ...
    <div class="gap-2 grid grid-cols-2">
      ...
      <div class="grid gap-2 grid-cols-3 w-full">
        <a href="/authors/{{$author->id}}" class="bg-green-400 px-2 py-1 rounded-md border-black border-[3px] shadow-[3px_3px] hover:shadow-[1px_1px]">Detail</a>
        <a href="/authors/{{$author->id}}/edit" class="bg-sky-400 px-2 py-1 rounded-md border-black border-[3px] shadow-[3px_3px] hover:shadow-[1px_1px]">Edit</a>
